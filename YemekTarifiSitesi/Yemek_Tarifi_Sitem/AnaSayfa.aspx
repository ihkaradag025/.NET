                ...
                <table class="auto-style1">
                    <tr>
                        <td><strong>
                          ...
                          <a href="YemekDetay.aspx?Yemekid=<%# Eval("Yemekid") %>"> <asp:Label ID="Label3" runat="server" BackColor="#FFFFCC" CssClass="auto-style5" ForeColor="#FF3300" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
                            </strong></td>
